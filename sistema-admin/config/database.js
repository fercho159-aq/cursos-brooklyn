    ...
    try {
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS cursos (
                ...
                descripcion TEXT,
                costo DECIMAL(10,2) DEFAULT 1700,
        ...
        await client.query(`
            ...
            ('Inglés', 'Cursos de inglés con certificación Oxford y SELPIP', 1700, 4),
            ('Marketing', 'Cursos de marketing digital y redes sociales', 1700, 4)
        `);
